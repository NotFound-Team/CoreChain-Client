  ...
  return (
    ...
    >
      ...
      <Box className="hidden md:block w-[35%]">
        <Image src="/images/block.png" width={500} height={500} className="w-full object-cover" alt="Block" />
      </Box>
        ...
        <Box sx={{ p: 4, boxShadow: 3, borderRadius: 2, bgcolor: "background.paper", maxWidth: 700 }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "4px" }}>
              <Typography sx={{ color: theme.palette.text.primary }}>{"Don't have an account?"}</Typography>
              <Link
                style={{
